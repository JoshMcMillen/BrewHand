...
function activate(context) {
    ...
    // Register commands
    context.subscriptions.push(vscode.commands.registerCommand('quality-first.enhanceSelection', enhanceSelectedCode), vscode.commands.registerCommand('quality-first.generateWithQuality', generateQualityCode), vscode.commands.registerCommand('quality-first.reviewCode', reviewCodeQuality), vscode.commands.registerCommand('quality-first.showUsageDashboard', () => {
...
async function showUsageDashboard(budgetManager) {
    const panel = vscode.window.createWebviewPanel('qualityFirstUsage', 'Quality-First Usage Dashboard', vscode.ViewColumn.One, {
        enableScripts: true
    });
