...
function activate(context) {
    ...
    // Register tree views
    context.subscriptions.push(vscode.window.registerTreeDataProvider('brewhand-features', featuresProvider), vscode.window.registerTreeDataProvider('brewhand-settings', settingsProvider));
